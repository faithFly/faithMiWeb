$(function (){
    ...
    layui.use('table', function(){
        ...
        var url='http://112.124.10.13:5001/api/Shopping/GetShoppingcart?userId='+userId;
        //第一个实例
        table.render({
          id:'idTest',
          elem: '#demo'
         ...
         //将token设置到请求头headers中
          $.ajaxSetup({
            headers:{
                ...
                //ajax生成订单
                $.ajax({
                  url: "http://112.124.10.13:5001/api/Order/AddOrderProduct",
                  type: "post",
...
function fun1(d){
  ...
  //添加购物车
  $.ajax({
    url: "http://112.124.10.13:5001/api/Shopping/DelShopping",
    type: "post",
